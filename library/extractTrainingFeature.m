...
% Copyright 2014 The MathWorks, Inc.
    data = load(fileName); % load recorded data
    
    %resampling
    
    rawData.t = data(:,1)/1000;
    
    rawData.a = data(:,2:end);
    
    % remove non unique data
    [rawData.t, index] = unique(rawData.t);
    rawData.a = rawData.a(index,:);
